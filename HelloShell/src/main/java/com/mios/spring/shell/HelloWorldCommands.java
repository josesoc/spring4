...
/**
 * http://docs.spring.io/spring-shell/docs/current/reference/html/simple-application.html
 * http://docs.spring.io/spring-shell/docs/current/reference/htmlsingle/
 * https://simplesassim.wordpress.com/tag/spring-shell/
